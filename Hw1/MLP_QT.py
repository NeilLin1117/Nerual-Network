...
class Window(QWidget):
    def __init__(self):
        ...
        self.train_btn.move(20, 220)
        self.train_btn.clicked.connect(self.train_showDialog)
        #self.train_btn.setEnabled(False)

        self.train_qlabel = QLabel(self)
        self.train_qlabel.move(320,20)
        self.train_result = QLabel(self)
        self.train_result.move(320,270)
        self.test_qlabel = QLabel(self)
        self.test_qlabel.move(820,20)
        self.test_result = QLabel(self)
        self.test_result.move(820,270)
        self.train_image = QLabel(self)
        self.train_image.setGeometry(320,50,400,200)
        self.test_image = QLabel(self)
        self.test_image.setGeometry(820,50,400,200)
        ...
        self.textEdit1.setGeometry(20,330,560,300)
        self.textEdit2 = QTextEdit(self)
        self.textEdit2.setGeometry(600,330,560,300)
        self.show()
    ...
    def train_showDialog(self):
        ...
        self.train_acc , self.test_acc = MLP.main_program(self.file,
                self.epochs,self.hidden,self.eta,self.seed)
    ...
    def ComboBox(self):
        ...
        self.qlabel.setText(fileNames[0])
        self.qlabel.move(140,20)
